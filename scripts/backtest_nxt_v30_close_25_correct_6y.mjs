...
const outDir = path.resolve("outputs", "nxt_crypto_btc_sol_sui_6y_v30_close_25_correct");
const jsonPath = path.join(outDir, "nxt_v30_close_25_correct_6y_results.json");
const xlsxPath = path.join(outDir, "NXT_V30_Close_25_Correct_6Y_BTC_SOL_SUI.xlsx");
